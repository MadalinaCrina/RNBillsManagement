...
import {BillList, BillEdit, BillDelete} from './bill';
...
export class Router extends Component {
  ...
  renderScene(route, navigator) {
    ...
    switch (route.name) {
      ...
      case BillEdit.routeName:
          return <BillEdit
          store={this.props.store}
          navigator={navigator}/>
      case BillDelete.routeName:
          return <BillDelete
          store={this.props.store}
          navigator={navigator}/>
      case BillList.routeName:
      default:
        return <BillList
          store={this.props.store}
          navigator={navigator}
  ...
  onAuthSucceeded() {
    ...
    this.navigator.push(BillList.route);
  }
}
